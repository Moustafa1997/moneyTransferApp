...
exports.getAvailability = async (req, res) => {
  try {
    ...
    //     { day: 'monday', startTime: '09:00', endTime: '18:00', agencyId: client.id, rank: 1 },
    //     { day: 'tuesday', startTime: '09:00', endTime: '18:00', agencyId: client.id, rank: 2 },
    //     { day: 'wednesday', startTime: '09:00', endTime: '18:00', agencyId: client.id, rank: 3 },
    //     { day: 'thursday', startTime: '09:00', endTime: '18:00', agencyId: client.id, rank: 4 },
    //     { day: 'friday', startTime: '09:00', endTime: '18:00', agencyId: client.id, rank: 5 },
    //     { day: 'saturday', startTime: null, endTime: null, agencyId: client.id, rank: 6 },
    //     { day: 'sunday', startTime: null, endTime: null, agencyId: client.id, rank: 7 }
    //   ]);
    // }
    const availability = await Availability.findAll({
